System.register(["__unresolved_0", "cc", "events"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      mEmitter = (_dec = ccclass('mEmitter'), _dec(_class = (_class2 = class mEmitter {
        constructor() {
          ...
          (_crd && Emitter === void 0 ? (_reportPossibleCrUseOfEmitter({
            error: Error()
          }), Emitter) : Emitter).instance = this._emitter;
        }
        ...
        registerOnce(event, listener, node) {
...
//# sourceMappingURL=34aa59f3ced8655a3071bbd10b204b59441740c7.js.map
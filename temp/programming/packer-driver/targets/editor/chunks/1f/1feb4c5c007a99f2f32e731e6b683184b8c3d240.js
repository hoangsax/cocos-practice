System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Collider2D, physics, _dec, _class, _class2, _descriptor, _crd, ccclass, property, BulletController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'Collider2D', 'ICollisionEvent', 'physics']);
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec(_class = (_class2 = class BulletController extends Component {
        ...
        start() {
          let collider = this.getComponent(Collider2D); // Lắng nghe sự kiện trigger

          collider.on('onTriggerEnter', this.onCollisionEnter, this); // Lắng nghe sự kiện va chạm vật lý
...
//# sourceMappingURL=1feb4c5c007a99f2f32e731e6b683184b8c3d240.js.map
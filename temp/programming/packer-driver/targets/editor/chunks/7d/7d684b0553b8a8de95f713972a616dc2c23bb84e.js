      ...
      _export("TitleScreen", TitleScreen = (_dec = ccclass('TitleScreen'), _dec(_class = class TitleScreen extends Component {
        start() {
          ...
          console.log((_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).instance.popupNode); // GameState.instance.popupNode.parent = this.node.parent;
        }
...
//# sourceMappingURL=7d684b0553b8a8de95f713972a616dc2c23bb84e.js.map
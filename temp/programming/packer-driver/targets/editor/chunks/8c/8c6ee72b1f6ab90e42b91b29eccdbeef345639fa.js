      ...
      _export("SettingPopup", SettingPopup = (_dec = ccclass('SettingPopup'), _dec2 = property(Button), _dec3 = property(Slider), _dec4 = property(Button), _dec5 = property(Slider), _dec(_class = (_class2 = class SettingPopup extends Component {
        ...
        initMusicButton() {
          ...
          console.log((_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance.bgmSource.volume);
          console.log(this.bgmSlider.progress);
          console.log(this.sfxSlider.progress); // this.bgmSlider.progress = AudioManager.instance.getBGMVolume();
        }
        ...
        closeSetting() {
          ...
          (_crd && PopupManager === void 0 ? (_reportPossibleCrUseOfPopupManager({
            error: Error()
          }), PopupManager) : PopupManager).instance.closeSetting();
        }
...
//# sourceMappingURL=8c6ee72b1f6ab90e42b91b29eccdbeef345639fa.js.map
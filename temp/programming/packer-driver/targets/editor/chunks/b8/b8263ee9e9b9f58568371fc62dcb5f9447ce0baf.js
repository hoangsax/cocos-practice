    ...
    execute: function () {
      ...
      _export("CharItem", CharItem = (_dec = ccclass('CharItem'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharItem extends Component {
        ...
        onMove(dt) {
          ...
          if (moveX !== 0 || moveY !== 0) {
            let posX = this.getWorldPosition().x + moveX * this.speed * dt;
            let posY = this.getWorldPosition().y + moveY * this.speed * dt;
...
//# sourceMappingURL=b8263ee9e9b9f58568371fc62dcb5f9447ce0baf.js.map
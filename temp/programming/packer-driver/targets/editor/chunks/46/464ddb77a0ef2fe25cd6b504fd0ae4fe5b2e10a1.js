System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, mEmitter, EventListenerType, GameScreenState, GameStateType, _dec, _class, _crd, ccclass, property, Control;
      ...
      _export("Control", Control = (_dec = ccclass('Control'), _dec(_class = class Control extends Component {
        ...
        pauseGame() {
          (_crd && mEmitter === void 0 ? (_reportPossibleCrUseOfmEmitter({
            ...
            error: Error()
          }), GameStateType) : GameStateType).PAUSE);
        }
        ...
        unPauseGame() {
          (_crd && mEmitter === void 0 ? (_reportPossibleCrUseOfmEmitter({
            ...
            error: Error()
          }), GameStateType) : GameStateType).UNPAUSE, (_crd && GameScreenState === void 0 ? (_reportPossibleCrUseOfGameScreenState({
            error: Error()
          }), GameScreenState) : GameScreenState).LOBBY);
        }
...
//# sourceMappingURL=464ddb77a0ef2fe25cd6b504fd0ae4fe5b2e10a1.js.map
System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'BoxCollider2D', 'Contact2DType', 'ICollisionEvent']);
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec(_class = (_class2 = class BulletController extends Component {
        ...
        start() {
          ...
          if (this.boxCollider) {
            ...
            this.boxCollider.on(Contact2DType.END_CONTACT, this.hitAnnounce, this); // Note: You can also listen to PRE_SOLVE and POST_SOLVE if needed
          }
        }
...
//# sourceMappingURL=cd02f3074d12720285a7c6ab0c3e14c8ea1ca612.js.map
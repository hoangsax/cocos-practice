System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, mEmitter, CharacterEventType, EventListenerType, GameState, BulletManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, CharacterManager;
  ...
  function _reportPossibleCrUseOfBulletManager(extras) {
    _reporterNs.report("BulletManager", "../bullet/manager", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      BulletManager = _unresolved_5.BulletManager;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("CharacterManager", CharacterManager = (_dec = ccclass('CharacterManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class CharacterManager extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "charItemNode", _descriptor, this);
        ...
        onPressShoot() {
          ...
          this.bulletManager.getComponent(_crd && BulletManager === void 0 ? (_reportPossibleCrUseOfBulletManager({
            error: Error()
          }), BulletManager) : BulletManager).createBullet(this.charItemNode.posFire);
        }
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "charItemNode", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=6cb125e3c5cf8d843de20d756420b4e0ee94fd4c.js.map
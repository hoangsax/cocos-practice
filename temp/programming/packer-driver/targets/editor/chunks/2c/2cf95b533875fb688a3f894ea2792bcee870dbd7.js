System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, ProgressBar, Label, SceneName, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, loading;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          director.preloadScene((_crd && SceneName === void 0 ? (_reportPossibleCrUseOfSceneName({
            error: Error()
          }), SceneName) : SceneName).TITLE, (completedCount, totalCount, item) => {
...
//# sourceMappingURL=2cf95b533875fb688a3f894ea2792bcee870dbd7.js.map
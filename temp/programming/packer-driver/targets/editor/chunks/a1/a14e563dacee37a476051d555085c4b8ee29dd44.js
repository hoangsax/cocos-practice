System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Vec3, Collider2D, Contact2DType, Pooling, _dec, _class, _class2, _descriptor, _crd, ccclass, property, BulletController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'Collider2D', 'Contact2DType']);
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec(_class = (_class2 = class BulletController extends (_crd && Pooling === void 0 ? (_reportPossibleCrUseOfPooling({
        ...
        onLoad() {
          ...
          this.rigidBody = this.node.getComponent(Collider2D);
          console.log(this.rigidBody);

          if (this.rigidBody) {
            this.rigidBody.on(Contact2DType.BEGIN_CONTACT, this.hitAnnounce, this);
          }
        }
...
//# sourceMappingURL=a14e563dacee37a476051d555085c4b8ee29dd44.js.map
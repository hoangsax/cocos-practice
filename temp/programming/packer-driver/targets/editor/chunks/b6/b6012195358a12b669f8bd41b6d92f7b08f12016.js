System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Event', 'sp', 'Canvas', 'Vec3', 'UITransform']);
      ...
      _export("CharItem", CharItem = (_dec = ccclass('CharItem'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharItem extends Component {
        ...
        limitPositionOnScene() {
          console.log(this.canvas.width); // if (this.getNodePosition().x < -this.canvas.width / 2 + charProps.scencePaddingLeft) {
        ...
        onMove(dt) {
          ...
          if (moveX !== 0 || moveY !== 0) {
            this.getNodePosition().x += moveX * this.speed * dt;
            this.getNodePosition().y += moveY * this.speed * dt;
            this.isMoving = true;
          } else {
            this.isMoving = false;
          }
...
//# sourceMappingURL=b6012195358a12b669f8bd41b6d92f7b08f12016.js.map
    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class BulletManager extends Component {
        ...
        createBullet() {
          ...
          bullet.setPosition(new Vec3(this.posFire.worldPosition.x - this.node.position.x, this.posFire.worldPosition.y - this.node.position.y, 0));
          console.log(bullet);
        }
...
//# sourceMappingURL=b5b79f4dc5e5219e11cb24daf6f0e51fab5a640c.js.map
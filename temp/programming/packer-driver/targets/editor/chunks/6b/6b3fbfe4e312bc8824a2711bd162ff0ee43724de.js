System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AudioSource, Component, Node, mEmitter, GameStateType, GameState, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, PopupController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PopupController", PopupController = (_dec = ccclass('PopupController'), _dec2 = property(Node), _dec3 = property(AudioSource), _dec(_class = (_class2 = class PopupController extends Component {
        constructor(...args) {
          super(...args);
        ...
        initMusicButton() {
          if (this.musicButton) {
            this.musicButton.children[0].active = (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
              error: Error()
            }), GameState) : GameState).instance.music;
            this.musicButton.children[1].active = !(_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
              error: Error()
            }), GameState) : GameState).instance.music;
          }
        } // setLobby(event: any) {
...
//# sourceMappingURL=6b3fbfe4e312bc8824a2711bd162ff0ee43724de.js.map
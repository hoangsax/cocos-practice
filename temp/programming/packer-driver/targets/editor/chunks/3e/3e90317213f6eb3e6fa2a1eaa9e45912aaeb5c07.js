System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, Canvas, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, manager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("manager", manager = (_dec = ccclass('manager'), _dec2 = property(Prefab), _dec3 = property(Canvas), _dec(_class = (_class2 = class manager extends Component {
        constructor(...args) {
          super(...args);
        ...
        spawnMonster() {
          ...
          monster.setPosition(0, Math.random() * this.node, 0);
        }
...
//# sourceMappingURL=3e90317213f6eb3e6fa2a1eaa9e45912aaeb5c07.js.map
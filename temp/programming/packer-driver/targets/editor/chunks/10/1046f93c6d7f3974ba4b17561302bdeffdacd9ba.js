    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class BulletManager extends Component {
        ...
        createBullet() {
          ...
          let bullet = this.bulletPool.get(this.bulletPrefab); // let bullet2 = this.bulletPool.get(this.bulletPrefab) as BulletNode;
...
//# sourceMappingURL=1046f93c6d7f3974ba4b17561302bdeffdacd9ba.js.map
System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, BoxCollider2D, _dec, _class, _class2, _descriptor, _crd, ccclass, property, BulletController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'BoxCollider2D', 'rig', 'Contact2DType', 'IPhysics2DContact']);
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec(_class = (_class2 = class BulletController extends Component {
        ...
        onLoad() {
          ...
          if (myCollider) {// 2. Tell the engine to listen for the exact moment of impact
...
//# sourceMappingURL=af6561898e5ff14f6ee665f78b989305561c4d51.js.map
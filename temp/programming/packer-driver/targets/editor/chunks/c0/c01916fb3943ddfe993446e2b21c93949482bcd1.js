System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Pooling, mEmitter, CharacterEventType, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, BulletManager;
    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class BulletManager extends Component {
        ...
        createBullet() {
          ...
          bullet.active = true; // bullet.setPosition(new Vec3(this.posFire.worldPosition.x - this.node.worldPosition.x, this.posFire.worldPosition.y - this.node.worldPosition.y, 0));
...
//# sourceMappingURL=c01916fb3943ddfe993446e2b21c93949482bcd1.js.map
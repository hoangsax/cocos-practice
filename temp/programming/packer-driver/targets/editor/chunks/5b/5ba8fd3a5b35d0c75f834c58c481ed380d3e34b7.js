System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, BoxCollider2D, Contact2DType, ProgressBar, BulletController, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, MonsterController;
  ...
  function _reportPossibleCrUseOfBulletController(extras) {
    _reporterNs.report("BulletController", "../bullet/controller", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      BulletController = _unresolved_2.BulletController;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec2 = property(ProgressBar), _dec(_class = (_class2 = class MonsterController extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (otherCollider.node instanceof (_crd && BulletController === void 0 ? (_reportPossibleCrUseOfBulletController({
            error: Error()
...
//# sourceMappingURL=5ba8fd3a5b35d0c75f834c58c481ed380d3e34b7.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AudioSource, Button, Component, mEmitter, GameStateType, GameState, onButtonClick, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, PopupController;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4a661WLdKVFt70xJqMeWCK0", "globalPopup", undefined);
      ...
      _export("PopupController", PopupController = (_dec = ccclass('PopupController'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(AudioSource), _dec(_class = (_class2 = class PopupController extends Component {
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "soundButton", _descriptor, this);

          _initializerDefineProperty(this, "musicButton", _descriptor2, this);
        ...
        initMusicButton() {
          if (this.musicButton) {// this.musicButton.children[0].active = GameState.instance.music;
        ...
        onClickHoli() {
          console.log(this.musicButton);
          (_crd && onButtonClick === void 0 ? (_reportPossibleCrUseOfonButtonClick({
            error: Error()
          }), onButtonClick) : onButtonClick)(this.musicButton); // let temp = GameState.instance.popupNode;
          // if (temp) {
        ...
        toggleSound() {
          (_crd && onButtonClick === void 0 ? (_reportPossibleCrUseOfonButtonClick({
            error: Error()
          }), onButtonClick) : onButtonClick)(this.musicButton);
        }
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "soundButton", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "musicButton", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=0c45d09b4eac42f9d0cbb055a457d80ff4fcc79f.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransform, mEmitter, CharacterEventType, GameCommand, GameState, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, CharacterManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharacterManager", CharacterManager = (_dec = ccclass('CharacterManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharacterManager extends Component {
        ...
        onGameStart() {
          this.charItem.active = true; // this.charItem.setCanPlay(true);
        }
...
//# sourceMappingURL=c7081ad9d809f04af6753cc82a93bdf39a9f459d.js.map
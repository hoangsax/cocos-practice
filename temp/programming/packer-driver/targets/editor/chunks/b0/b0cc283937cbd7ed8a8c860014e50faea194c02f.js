System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AudioSource, Button, Component, Slider, mEmitter, GameStateType, onButtonClick, AudioManager, PopupManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, SettingPopup;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      onButtonClick = _unresolved_4.onButtonClick;
    ...
    execute: function () {
      ...
      _export("SettingPopup", SettingPopup = (_dec = ccclass('SettingPopup'), _dec2 = property(Button), _dec3 = property(Slider), _dec4 = property(Button), _dec5 = property(Slider), _dec6 = property(AudioSource), _dec(_class = (_class2 = class SettingPopup extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "musicSource", _descriptor5, this);
        }
        ...
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "musicSource", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=b0cc283937cbd7ed8a8c860014e50faea194c02f.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, AudioSource, GameState, SceneName, AudioManager, mEmitter, PopupManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, RootManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RootManager", RootManager = (_dec = ccclass('RootManager'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class RootManager extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "pausePopup", _descriptor6, this);
        }
        ...
        audioManagerInit() {
          ...
          const audio = (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
        ...
        popupManagerInit() {
          ...
          const popup = (_crd && PopupManager === void 0 ? (_reportPossibleCrUseOfPopupManager({
            error: Error()
        ...
        writable: true,
        initializer: null
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "pausePopup", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=9968276da08e58c02281dd5101fa36edc8fd9fc7.js.map
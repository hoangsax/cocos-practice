    ...
    execute: function () {
      ...
      _export("PopupController", PopupController = (_dec = ccclass('PopupController'), _dec2 = property(Button), _dec3 = property(AudioSource), _dec(_class = (_class2 = class PopupController extends Component {
        ...
        onClickHoli() {
          ...
          this.musicButton.enabled = !this.musicButton.enabled; // let temp = GameState.instance.popupNode;
          // if (temp) {
...
//# sourceMappingURL=e71443082a91f9e6a39543ecaa029401b2d8614a.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, BoxCollider2D, Contact2DType, GameState, _dec, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, BulletController;
    ...
    execute: function () {
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec(_class = (_class2 = class BulletController extends Component {
        ...
        move(deltaTime) {
          ...
          console.log(this.node.position.x - this._initPositionX);
        }
...
//# sourceMappingURL=3b771181e59922342982cd634a14d5821a44cccf.js.map
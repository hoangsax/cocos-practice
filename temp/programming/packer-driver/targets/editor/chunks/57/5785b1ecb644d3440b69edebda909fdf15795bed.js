System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, AudioSource, GameState, ScreenName, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, RootManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RootManager", RootManager = (_dec = ccclass('RootManager'), _dec2 = property(Node), _dec3 = property(AudioSource), _dec4 = property(AudioSource), _dec(_class = (_class2 = class RootManager extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "bgmSource", _descriptor3, this);
        }
        ...
        onLoad() {
          ...
          (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).instance.root = this.node; // GameState.instance.musicSource = this.musicSource;
        ...
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "bgmSource", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=5785b1ecb644d3440b69edebda909fdf15795bed.js.map
System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, RootManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RootManager", RootManager = (_dec = ccclass('RootManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class RootManager extends Component {
        ...
        onLoad() {
          this.popup.active = true; // director.addPersistRootNode(this.node);

          director.addPersistRootNode(this.gameManager);
          director.addPersistRootNode(this.popup); // director.loadScene('loading');
        }
...
//# sourceMappingURL=09b2de705ae00a4284b9712b6252e67c9319e26d.js.map
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class BulletManager extends Component {
        ...
        onEnable() {
          this.node.createBullet = this.createBullet.bind(this); // mEmitter.instance.registerEvent(CharacterEventType.SHOOT, this.createBullet.bind(this), this.node);
        }
...
//# sourceMappingURL=9cd501e4a687b87f2547955ce94807a13e011998.js.map
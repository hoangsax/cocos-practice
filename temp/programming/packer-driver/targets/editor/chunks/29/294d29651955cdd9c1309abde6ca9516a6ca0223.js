  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharItem", CharItem = (_dec = ccclass('CharItem'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharItem extends Component {
        ...
        limitPositionOnScene() {// if (this.getNodePosition().x < -this.canvas.width / 2 + charProps.scencePaddingLeft) {
...
//# sourceMappingURL=294d29651955cdd9c1309abde6ca9516a6ca0223.js.map
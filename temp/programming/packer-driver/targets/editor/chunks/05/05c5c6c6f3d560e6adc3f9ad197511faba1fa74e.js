  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharacterManager", CharacterManager = (_dec = ccclass('CharacterManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharacterManager extends Component {
        ...
        start() {
          console.log(this.uiTransform.height); // this.charItem.setMaxResolution(this.uiTransform.height, this.uiTransform.width);
        }
...
//# sourceMappingURL=05c5c6c6f3d560e6adc3f9ad197511faba1fa74e.js.map
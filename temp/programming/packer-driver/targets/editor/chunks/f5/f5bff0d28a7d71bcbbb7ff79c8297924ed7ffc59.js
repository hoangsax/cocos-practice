System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, BoxCollider2D, RigidBody2D, GameState, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, BulletController;
    ...
    execute: function () {
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec2 = property(BoxCollider2D), _dec3 = property(RigidBody2D), _dec(_class = (_class2 = class BulletController extends Component {
        ...
        onLoad() {
          ...
          this.initState(); // this.startListener();
        }

        onEnable() {
          this.initState(); // if (this.rigidBody) {
        ...
        update(deltaTime) {
          if (!(_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).instance.is) {
            this.move(deltaTime);
          }
        }

        initState() {
          this.node.getScript = this.getScript.bind(this);
...
//# sourceMappingURL=f5bff0d28a7d71bcbbb7ff79c8297924ed7ffc59.js.map
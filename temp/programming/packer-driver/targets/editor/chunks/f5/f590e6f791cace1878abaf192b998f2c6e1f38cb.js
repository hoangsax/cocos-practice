  ...
  return {
    ...
    execute: function () {
      ...
      _export("mEmitter", mEmitter = (_dec = ccclass('mEmitter'), _dec(_class = (_class2 = class mEmitter {
        ...
        removeAllEvent(node) {
          console.log(this.eventListeners.get(node)); // this.eventListeners.get(node).forEach((item: listenerType) => {
...
//# sourceMappingURL=f590e6f791cace1878abaf192b998f2c6e1f38cb.js.map
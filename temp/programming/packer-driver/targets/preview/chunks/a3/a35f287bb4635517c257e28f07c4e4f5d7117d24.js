System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, sp, Vec3, UITransform, MoveDirection, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, charProps, CharItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharItem", CharItem = (_dec = ccclass('CharItem'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharItem extends Component {
        ...
        onLoad() {
          this.animations = this.skeleton._skeleton.data.animations.map(item => item.name); // this.node.PosFire = this.posFire.position.clone();
        ...
        //     if (!this.isReload) {
        //         this.isReload = true;
        //         this.playAnimation(this.animations['walk'], false, 0);
        //         this.playAnimation(this.animations.shoot, false, 1);
        //     }
        // }
        // onReloadDone() {
        //     this.isReload = false;
        ...
        //     this.skeleton.setAnimation(track, animationName, loop, 0);
        // }
        // addAnimation(animationName, loop = true) {
        //     this.skeleton.clearTracks();
        //     this.skeleton.setToSetupPose();
        //     this.skeleton.addAnimation(0, animationName, loop, 0);
        // }
...
//# sourceMappingURL=a35f287bb4635517c257e28f07c4e4f5d7117d24.js.map
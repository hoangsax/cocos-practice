System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Node, mEmitter, GameStateType, GameState, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PopupController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PopupController", PopupController = (_dec = ccclass('PopupController'), _dec2 = property(Node), _dec(_class = (_class2 = class PopupController extends Component {
        ...
        initMusicButton() {
          if (this.music) {
            console.log(this.music.children);
          }
        } // setLobby(event: any) {
...
//# sourceMappingURL=8affa135feb6771a057d536470acbbc3f8af6a05.js.map
      ...
      _export("SettingPopup", SettingPopup = (_dec = ccclass('SettingPopup'), _dec2 = property(Button), _dec3 = property(Slider), _dec4 = property(Button), _dec5 = property(Slider), _dec(_class = (_class2 = class SettingPopup extends Component {
        ...
        setVolume(value) {
          (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance.setBGMVolume(this.bgmSlider.progress);
          (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance.setSFXVolume(this.sfxSlider.progress);
...
//# sourceMappingURL=8ab866678e8cd8d1b874761424623e014c356f5f.js.map
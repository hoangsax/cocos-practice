    ...
    execute: function () {
      ...
      _export("CharItem", CharItem = (_dec = ccclass('CharItem'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharItem extends Component {
        ...
        onMove(dt) {
          ...
          if (moveX !== 0 || moveY !== 0) {
            var posX = this.getWorldPosition().x + moveX * this.speed * dt;
            var posY = this.getWorldPosition().y + moveY * this.speed * dt;
...
//# sourceMappingURL=9119d6852a29109254b290c57d0439eeb256ce54.js.map
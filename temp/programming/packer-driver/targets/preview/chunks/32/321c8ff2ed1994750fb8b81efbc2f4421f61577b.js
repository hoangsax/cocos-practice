  ...
  return {
    ...
    execute: function () {
      ...
      _export("RootManager", RootManager = (_dec = ccclass('RootManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class RootManager extends Component {
        ...
        onLoad() {
          this.popup.active = false; // director.addPersistRootNode(this.node);

          director.addPersistRootNode(this.gameManager); // director.loadScene('loading');
        }
...
//# sourceMappingURL=321c8ff2ed1994750fb8b81efbc2f4421f61577b.js.map
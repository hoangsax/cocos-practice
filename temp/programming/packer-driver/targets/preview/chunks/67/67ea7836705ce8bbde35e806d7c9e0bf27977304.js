System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AudioSource, Button, Component, mEmitter, GameStateType, GameState, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, PopupController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PopupController", PopupController = (_dec = ccclass('PopupController'), _dec2 = property(Button), _dec3 = property(AudioSource), _dec(_class = (_class2 = class PopupController extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "musicButton", _descriptor, this);
        ...
        onClickHoli() {
          ...
          this.musicButton.normalSprite = this.musicButton.disabledSprite; // let temp = GameState.instance.popupNode;
          // if (temp) {
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "musicButton", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=67ea7836705ce8bbde35e806d7c9e0bf27977304.js.map
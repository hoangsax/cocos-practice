      ...
      _export("GameState", GameState = (_dec = ccclass('GameState'), _dec(_class = (_class2 = class GameState {
        constructor() {
          ...
          if (GameState.instance) {
            if (this._popupNode) {
              director.getScene().addChild(this._popupNode);
            }
        ...
        set popupNode(value) {
          ...
          this._popupNode.parent = director.getScene() ? director.getScene() : this.popupNode.parent;
        }
...
//# sourceMappingURL=29f9911a9116a351ca826a97dda58d5b07f18983.js.map
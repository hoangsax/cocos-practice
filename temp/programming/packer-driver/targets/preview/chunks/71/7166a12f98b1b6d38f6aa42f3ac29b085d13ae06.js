System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, KeyCode, director, Label, mEmitter, CharacterEventType, GameCommand, MoveDirection, GameState, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, mainGame;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("mainGame", mainGame = (_dec = ccclass('mainGame'), _dec2 = property(Node), _dec3 = property(Label), _dec(_class = (_class2 = class mainGame extends Component {
        constructor() {
          super(...arguments);
        ...
        update(dt) {
          if (this._startCountdown > 0) {
            !this._isStart && (_crd && mEmitter === void 0 ? (_reportPossibleCrUseOfmEmitter({
              error: Error()
            }), mEmitter) : mEmitter).instance.emit((_crd && GameCommand === void 0 ? (_reportPossibleCrUseOfGameCommand({
              error: Error()
            }), GameCommand) : GameCommand).START, true);
            ...
            this._stageLimitTime -= dt;
            this.timer.string = Math.floor(this._stageLimitTime).toString();

            if (this._stageLimitTime <= 0) {
              this.timer.string = '0';
...
//# sourceMappingURL=7166a12f98b1b6d38f6aa42f3ac29b085d13ae06.js.map
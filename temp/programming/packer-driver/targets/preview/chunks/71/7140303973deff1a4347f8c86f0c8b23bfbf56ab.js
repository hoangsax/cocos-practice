System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, input, Input, KeyCode, director, Label, mEmitter, CharacterEventType, GameCommand, MoveDirection, SceneName, GameState, PopupManager, AudioManager, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, mainGame;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("mainGame", mainGame = (_dec = ccclass('mainGame'), _dec2 = property(Label), _dec(_class = (_class2 = class mainGame extends Component {
        constructor() {
          super(...arguments);
        ...
        update(dt) {
          ...
          if (this._startCountdown > 0) {
            ...
            if (this._currentTimer <= 0) {
              this.timer.string = '0';
              this.showResult(); // mEmitter.instance.emit(GameCommand.END);
            }
          }
        }
        ...
        initState() {
          ...
          (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).instance.resetScore();
          this._startCountdown = 3;
          this._isStart = false;
        ...
        _handlePress(event) {
          ...
          var moveType = event.type === Input.EventType.KEY_DOWN ? (_crd && CharacterEventType === void 0 ? (_reportPossibleCrUseOfCharacterEventType({
            error: Error()
          ...
          var shootType = event.type === Input.EventType.KEY_DOWN ? (_crd && CharacterEventType === void 0 ? (_reportPossibleCrUseOfCharacterEventType({
            error: Error()
        ...
        showResult() {
          ...
          (_crd && PopupManager === void 0 ? (_reportPossibleCrUseOfPopupManager({
            error: Error()
          }), PopupManager) : PopupManager).instance.showResultPopup();
        }
        ...
        togglePause() {
          ...
          (_crd && PopupManager === void 0 ? (_reportPossibleCrUseOfPopupManager({
            error: Error()
          }), PopupManager) : PopupManager).instance.showPausePopup();
          (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "timer", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=7140303973deff1a4347f8c86f0c8b23bfbf56ab.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, PhysicsSystem2D, EPhysics2DDrawFlags, mEmitter, EventListenerType, GameScreenState, GameStateType, GameState, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GameManager;
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        onLoad() {
          ...
          (_crd && mEmitter === void 0 ? (_reportPossibleCrUseOfmEmitter({
            ...
            error: Error()
          }), GameStateType) : GameStateType).TOGGLEPAUSE, this.setLayerState.bind(this), this.node);
          this.initState();
        }
...
//# sourceMappingURL=93210fb6c73daf8e1aae55f934fb67576b3f7924.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Node, Vec3, instantiate, Pooling, mEmitter, CharacterEventType, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, BulletManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec3 = property([Prefab]), _dec4 = property(Node), _dec(_class = (_class2 = class BulletManager extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "posFire", _descriptor3, this);
        ...
        createBullet() {
          var bulletTemp = instantiate(this.Prefabs[id]);
        ...
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "posFire", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=b3800bf19f04b668fd1d9b6687a7262de7d02b69.js.map
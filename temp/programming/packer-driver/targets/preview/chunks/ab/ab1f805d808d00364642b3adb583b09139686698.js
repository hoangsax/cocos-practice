    ...
    execute: function () {
      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec2 = property(ProgressBar), _dec(_class = (_class2 = class MonsterController extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          var temp = otherCollider.node;
          console.log(temp.onHit);
          console.log(typeof otherCollider.node); // let damage = bullet.getDamage();
          // bullet.onHit();
          // this.onHit(damage)
        }
...
//# sourceMappingURL=ab1f805d808d00364642b3adb583b09139686698.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'sp', 'Vec3', 'UITransform', 'Vec2']);
      ...
      _export("CharacterController", CharacterController = (_dec = ccclass('CharacterController'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec(_class = (_class2 = class CharacterController extends Component {
        ...
        update(dt) {
          if (this._canPlay) {
            ...
            var currState = this._isMoving;
            this.onMove(dt);
            this.handleAnimation(currState);
            this._preReload = this._isReload;
          } else {// this.playAnimation(0, animations.idle);
          }
        }
        ...
        resetState() {
          ...
          this._isMovingDown = false;
          this._canPlay = false;
          this.node.setPosition(this._initPosition); // this.readyState();
          // this.playAnimation(1, animations.idle);
        }
        ...
        onMove(dt) {
          ...
          if (moveX !== 0 && moveY !== 0) {
            var distance = Math.sqrt((this._speed * dt) ** 2 / 2);
            ...
            var _posX = this.getNodePosition().x + moveX * this._speed * dt;

            var _posY = this.getNodePosition().y + moveY * this._speed * dt;
...
//# sourceMappingURL=ccbccda369d19be4fe7fbd6b5f9b2d8b9eeb4ed4.js.map
System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, manager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("manager", manager = (_dec = ccclass('manager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class manager extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "monsterPrefab", _descriptor, this);

          _initializerDefineProperty(this, "spawnInterval", _descriptor2, this);
...
//# sourceMappingURL=89725437545a62d5e511d32f9d2870750d8e2a16.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, KeyCode, director, Label, mEmitter, CharacterEventType, GameCommand, MoveDirection, SceneName, GameState, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, mainGame;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("mainGame", mainGame = (_dec = ccclass('mainGame'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Node), _dec(_class = (_class2 = class mainGame extends Component {
        ...
        playClickSound() {// GameState.instance.playClickSound();
        }
...
//# sourceMappingURL=6a7fd7dd00aa91764215e122de1c22bc85a7a939.js.map
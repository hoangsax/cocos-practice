System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, sp, Vec3, UITransform, MoveDirection, animations, GameState, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, charProps, CharacterController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharacterController", CharacterController = (_dec = ccclass('CharacterController'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharacterController extends Component {
        constructor() {
          super(...arguments);
        ...
        readyState() {
          // this.resetState();
          this.readyTime = 3; // this.playAnimation(0, animations.portal, false);
        }
        ...
        onMove(dt) {
          ...
          if (moveX !== 0 && moveY !== 0) {
            var distance = Math.sqrt((this.speed * dt) ** 2 / 2);
            var posX = this.getNodePosition().x + moveX * distance;
            var posY = this.getNodePosition().y + moveY * distance;
            this.node.setPosition(new Vec3(posX, posY, 0));
            this.isMoving = true;
          } else if (moveX !== 0 || moveY !== 0) {
            var _posX = this.getNodePosition().x + moveX * this.speed * dt;

            var _posY = this.getNodePosition().y + moveY * this.speed * dt;

            this.node.setPosition(new Vec3(_posX, _posY, 0));
            this.isMoving = true;
          } else {
            this.isMoving = false;
          }
...
//# sourceMappingURL=5a05a7c20a6a5a40813fdfe4c8805e1738f48263.js.map
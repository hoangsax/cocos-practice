      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec2 = property(ProgressBar), _dec(_class = (_class2 = class MonsterController extends Component {
        ...
        startListener() {
          if (this._boxCollider) {
            this._boxCollider.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact, this.node); // this.boxCollider.on(Contact2DType.END_CONTACT, this.onBeginContact, this);
        ...
        onDisable() {
          ...
          this._boxCollider.off(Contact2DType.BEGIN_CONTACT, this.onBeginContact, this.node);
...
//# sourceMappingURL=6164ded77ec14b1add636ea28fc7f45b5070b904.js.map
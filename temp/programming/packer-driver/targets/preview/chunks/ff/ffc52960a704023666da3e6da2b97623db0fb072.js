System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Vec3, Collider2D, Pooling, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, BulletManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Prefab', 'Node', 'Vec3', 'instantiate', 'Collider2D']);
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec3 = property(Collider2D), _dec(_class = (_class2 = class BulletManager extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "bulletPrefab", _descriptor, this);

          _initializerDefineProperty(this, "colliderBox", _descriptor2, this);
        ...
        createBullet(posFire) {
          var bullet = this.bulletPool.get(this.bulletPrefab, this.node);
          bullet.active = true;
          bullet.setPosition(new Vec3(posFire.worldPosition.x - this.node.worldPosition.x, posFire.worldPosition.y - this.node.worldPosition.y));
        ...
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "colliderBox", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=ffc52960a704023666da3e6da2b97623db0fb072.js.map
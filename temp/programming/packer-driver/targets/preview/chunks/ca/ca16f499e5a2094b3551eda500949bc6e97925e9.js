    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class BulletManager extends Component {
        ...
        createBullet() {
          ...
          var bullet = this.bulletPool.get(this.bulletPrefab); // let bullet2 = this.bulletPool.get(this.bulletPrefab) as BulletNode;
          ...
          bullet.addMethodReturnToPool(this.returnToPool.bind(this)); // console.log("2: ", this.bulletPool);
        }
...
//# sourceMappingURL=ca16f499e5a2094b3551eda500949bc6e97925e9.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Pooling, mEmitter, GameCommand, GameState, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, BulletManager;
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class BulletManager extends Component {
        ...
        update(dt) {
          (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).instance.isPause && console.log(this.bulletPool);
        }
...
//# sourceMappingURL=0b1850f0fbe9aa8888b84b42e1370041da83f910.js.map
    ...
    execute: function () {
      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec2 = property(ProgressBar), _dec(_class = (_class2 = class MonsterController extends Component {
        ...
        onLoad() {
          ...
          this.node.setReturnToPoolMethod = this.setReturnToPoolMethod.bind(this);
          this.startListener();
        }
        ...
        startListener() {
          if (this._boxCollider) {
            this._boxCollider.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact.bind(this), this.node); // this.boxCollider.on(Contact2DType.END_CONTACT, this.onBeginContact, this);
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          this.scheduleOnce(() => {
            var bullet = otherCollider.node.getScript();
        ...
        onDisable() {
          ...
          this._boxCollider.off(Contact2DType.BEGIN_CONTACT, this.onBeginContact.bind(this), this.node);
...
//# sourceMappingURL=4654539a957cc8b598bbaadccd396bb6ccba0bb6.js.map
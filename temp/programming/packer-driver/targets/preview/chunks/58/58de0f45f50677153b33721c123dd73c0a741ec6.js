  ...
  return {
    ...
    execute: function () {
      ...
      _export("PopupController", PopupController = (_dec = ccclass('PopupController'), _dec2 = property(Button), _dec3 = property(AudioSource), _dec(_class = (_class2 = class PopupController extends Component {
        ...
        onClickHoli() {
          console.log(this.musicButton.normalSprite = this.musicButton.disabledSprite); // let temp = GameState.instance.popupNode;
          // if (temp) {
...
//# sourceMappingURL=58de0f45f50677153b33721c123dd73c0a741ec6.js.map
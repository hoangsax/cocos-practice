  ...
  return {
    ...
    execute: function () {
      ...
      _export("mainGame", mainGame = (_dec = ccclass('mainGame'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Node), _dec(_class = (_class2 = class mainGame extends Component {
        ...
        exitGame() {
          director.preloadScene((_crd && ScreenName === void 0 ? (_reportPossibleCrUseOfScreenName({
            error: Error()
          }), ScreenName) : ScreenName).ROOT, () => {
            (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
              error: Error()
            }), GameState) : GameState).instance.destroy();
...
//# sourceMappingURL=7dcded43afe18bb335825c9bc47af63706cfda97.js.map
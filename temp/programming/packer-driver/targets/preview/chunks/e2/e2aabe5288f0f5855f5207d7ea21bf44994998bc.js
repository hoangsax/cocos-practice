    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class BulletManager extends Component {
        ...
        createBullet() {
          ...
          bullet.setPosition(new Vec3(this.posFire.worldPosition.x - this.node.worldPosition.x, this.posFire.worldPosition.y - this.node.worldPosition.y, 0)); // this.bulletPool.return(this.bulletPrefab, bullet);
...
//# sourceMappingURL=e2aabe5288f0f5855f5207d7ea21bf44994998bc.js.map
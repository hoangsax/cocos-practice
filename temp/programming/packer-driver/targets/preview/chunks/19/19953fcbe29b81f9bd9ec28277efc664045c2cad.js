System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, PhysicsSystem2D, EPhysics2DDrawFlags, mEmitter, EventListenerType, GameScreenState, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'PhysicsSystem2D', 'EPhysics2DDrawFlags']);
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        onLoad() {
          ...
          (_crd && mEmitter === void 0 ? (_reportPossibleCrUseOfmEmitter({
            ...
            error: Error()
          }), EventListenerType) : EventListenerType).SET_GAME_STATE, this.setGameState.bind(this), this.node);
          this.initState();
        }
        ...
        initState() {
          ...
          this.layerMap.get((_crd && GameScreenState === void 0 ? (_reportPossibleCrUseOfGameScreenState({
            error: Error()
          }), GameScreenState) : GameScreenState).PLAYING).active = false;
...
//# sourceMappingURL=19953fcbe29b81f9bd9ec28277efc664045c2cad.js.map
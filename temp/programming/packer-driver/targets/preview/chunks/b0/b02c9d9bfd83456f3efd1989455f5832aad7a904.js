  ...
  return {
    ...
    execute: function () {
      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec2 = property(ProgressBar), _dec(_class = (_class2 = class MonsterController extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {// (otherCollider.node as BulletNode).onHit();
        }
...
//# sourceMappingURL=b02c9d9bfd83456f3efd1989455f5832aad7a904.js.map
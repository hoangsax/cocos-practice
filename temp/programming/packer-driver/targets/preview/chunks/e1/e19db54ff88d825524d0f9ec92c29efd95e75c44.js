      ...
      _export("Control", Control = (_dec = ccclass('Control'), _dec(_class = class Control extends Component {
        onLoad() {
          new (_crd && mEmitter === void 0 ? (_reportPossibleCrUseOfmEmitter({
            error: Error()
          }), mEmitter) : mEmitter)(); // input.on(Input.EventType.KEY_DOWN, this.onClickEnable.bind(this), this)

          input.on(Input.EventType.KEY_PRESSING, this.onClickEnable.bind(this), this);
        }
...
//# sourceMappingURL=e19db54ff88d825524d0f9ec92c29efd95e75c44.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharacterManager", CharacterManager = (_dec = ccclass('CharacterManager'), _dec2 = property(Node), _dec3 = property(_crd && BulletManager === void 0 ? (_reportPossibleCrUseOfBulletManager({
        error: Error()
      }), BulletManager) : BulletManager), _dec(_class = (_class2 = class CharacterManager extends Component {
        constructor() {
          super(...arguments);
        ...
        onPressShoot() {
          ...
          this.bulletManager.createBullet(this.charItemNode.posFire);
        }
...
//# sourceMappingURL=01a43593306e3156437ce67a436848eb81aafa02.js.map
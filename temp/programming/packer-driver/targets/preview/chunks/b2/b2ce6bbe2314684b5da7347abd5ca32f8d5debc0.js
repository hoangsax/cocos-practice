System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'Collider']);
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec(_class = (_class2 = class BulletController extends Component {
        ...
        onCollisionEnter(selfCollider, otherCollider, contact) {
          console.log('hit');
        }
...
//# sourceMappingURL=b2ce6bbe2314684b5da7347abd5ca32f8d5debc0.js.map
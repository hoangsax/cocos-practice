System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameManager;
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        onLoad() {
          ...
          console.log('popup');
          director.addPersistRootNode(this.popup);
          console.log('unPop');
...
//# sourceMappingURL=57708ba63c00224f80a2fb00ef765300e91dc5e4.js.map
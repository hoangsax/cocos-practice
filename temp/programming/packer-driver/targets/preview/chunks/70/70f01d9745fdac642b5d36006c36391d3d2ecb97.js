      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec2 = property(ProgressBar), _dec(_class = (_class2 = class MonsterController extends Component {
        ...
        startListener() {
          if (this._boxCollider) {
            this._boxCollider.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact.bind(this), this); // this.boxCollider.on(Contact2DType.END_CONTACT, this.onBeginContact, this);
        ...
        onDisable() {
          ...
          this._boxCollider.off(Contact2DType.BEGIN_CONTACT, this.onBeginContact.bind(this), this);
...
//# sourceMappingURL=70f01d9745fdac642b5d36006c36391d3d2ecb97.js.map
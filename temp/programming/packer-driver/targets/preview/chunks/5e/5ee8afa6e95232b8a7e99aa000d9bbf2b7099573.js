System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, mEmitter, GameStateType, GameState, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PopupController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Button', 'Component', 'Game']);
      ...
      _export("PopupController", PopupController = (_dec = ccclass('PopupController'), _dec2 = property(Button), _dec(_class = (_class2 = class PopupController extends Component {
        constructor() {
          super(...arguments);
        ...
        initMusicButton() {
          if ((_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            ...
            this.music.interactable = true;
          } else {
            this.music.interactable = false;
          }
        } // setLobby(event: any) {
...
//# sourceMappingURL=5ee8afa6e95232b8a7e99aa000d9bbf2b7099573.js.map
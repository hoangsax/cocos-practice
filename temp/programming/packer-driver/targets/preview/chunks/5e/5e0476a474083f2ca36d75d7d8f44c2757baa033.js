System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, KeyCode, director, mEmitter, CharacterEventType, MoveDirection, GameState, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, mainGame;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'input', 'Input', 'EventKeyboard', 'KeyCode', 'director']);
      ...
      _export("mainGame", mainGame = (_dec = ccclass('mainGame'), _dec2 = property(Node), _dec(_class = (_class2 = class mainGame extends Component {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=5e0476a474083f2ca36d75d7d8f44c2757baa033.js.map
System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, BoxCollider2D, Contact2DType, _dec, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, MonsterController;
    ...
    execute: function () {
      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec(_class = (_class2 = class MonsterController extends Component {
        constructor() {
          ...
          _initializerDefineProperty(this, "hp", _descriptor2, this);
        ...
        move(dt) {// this.node.setPosition( this.node.position.x - this.speed * dt, this.node.position.y, 0);
        }
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "hp", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=0aee47b18a4673d223611c01dd70c6e0efa7ca0c.js.map
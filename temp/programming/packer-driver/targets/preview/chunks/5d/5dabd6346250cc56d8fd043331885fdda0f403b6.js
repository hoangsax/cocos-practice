    ...
    execute: function () {
      ...
      _export("CharItem", CharItem = (_dec = ccclass('CharItem'), _dec2 = property(Node), _dec3 = property(sp.Skeleton), _dec4 = property(UITransform), _dec(_class = (_class2 = class CharItem extends Component {
        ...
        onShoot() {
          if (!this.isReload) {
            this.isReload = true;
            this.playAnimation((_crd && animations === void 0 ? (_reportPossibleCrUseOfanimations({
              error: Error()
            }), animations) : animations).walk, false, 0);
            this.playAnimation((_crd && animations === void 0 ? (_reportPossibleCrUseOfanimations({
              error: Error()
            }), animations) : animations).shoot, false, 1);
          }
        }
...
//# sourceMappingURL=5dabd6346250cc56d8fd043331885fdda0f403b6.js.map
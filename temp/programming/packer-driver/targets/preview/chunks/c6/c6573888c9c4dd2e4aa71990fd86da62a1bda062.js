    ...
    execute: function () {
      ...
      _export("BulletController", BulletController = (_dec = ccclass('BulletController'), _dec(_class = (_class2 = class BulletController extends Component {
        ...
        onLoad() {
          ...
          this.node.addMethodReturnToPool = this.addMethodReturnToPool.bind(this)(this.node).getDamage = this.getDamage.bind(this);
        }
...
//# sourceMappingURL=c6573888c9c4dd2e4aa71990fd86da62a1bda062.js.map
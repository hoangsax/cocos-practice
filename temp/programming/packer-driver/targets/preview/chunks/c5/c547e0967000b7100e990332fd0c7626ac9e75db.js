System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, UITransform, Pooling, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, manager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("manager", manager = (_dec = ccclass('manager'), _dec2 = property(Prefab), _dec3 = property(UITransform), _dec(_class = (_class2 = class manager extends Component {
        ...
        spawnMonster() {
          if (!this.monsterPrefab) return; // const monster = this._monsterPool.get(this.monsterPrefab, this.node);
...
//# sourceMappingURL=c547e0967000b7100e990332fd0c7626ac9e75db.js.map